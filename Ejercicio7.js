...
// ejemplo, el nombre 'Luis' no debería estar en el resultado porque empieza con 'L'. 

let nombres = ['Ana', 'Luis', 'Andrea', 'María'];
let filtrados = nombres.filter(nombre => nombre.startsWith('A'));

filtrados.forEach(nombres => console.log(nombres));